      ...
      <div className="flex-1 px-6 sm:px-10 pb-12 pt-4">
        <div className="max-w-lg mx-auto">
          ...
          <p className="mt-6 text-center text-[11px] text-slate-400 leading-relaxed max-w-md mx-auto">
            ...
            <span className="text-teal-700 cursor-pointer hover:underline">Terms of Service</span>
            {' '}and{' '}
            <span className="text-teal-700 cursor-pointer hover:underline">Privacy Policy</span>.
          </p>
        </div>
      </div>
    </AuthLayout>
