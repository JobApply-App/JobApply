  ...
  return (
    ...
    >
      <div
        ...
        tabIndex={-1}
        className="relative w-full max-w-[520px] max-h-[90vh] overflow-y-auto rounded-2xl bg-white shadow-floating border border-slate-200 animate-modal-in outline-none"
