...
export const en = {
  ...
  auth_layout: {
    ...
    testimonial_quote:    'I was applying to jobs for 3 months with no response. JobApply got me 5 interviews in my first week.',
    testimonial_name:     'Daniel Levi',
    testimonial_initials: 'DL',
    testimonial_role:     'Product Manager, hired at Meta',
  },
